...
public class PeerFileReceiverAsyncTask  extends AsyncTask<String, Void, Void>{
	private static final String TAG = "PeerFileReceiverAsynTask";
	...
	protected Void doInBackground(String... arg0) {
		...
		PeerFileReceiver peerFileReceiverThread = new PeerFileReceiver(context, mHandler);
